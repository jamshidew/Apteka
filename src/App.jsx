  ...
  return (
    <div className="container">
      ...
      <div className="flex items-center justify-between p-4 gap-2 bg-white border-b">
        ...
        <div className="grow">
          <input type="text" placeholder="Dori qidirish" className="block w-full rounded-lg border-0 p-2 ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-blue-500 leading-6 undefined" />
        </div>
      </div>
    </div>
  );
